...
#In the following lines, I deleted the input_data variable and then created new variables for the new inputs
...
input_reciever = st.text_input("receiver")
